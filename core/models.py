...
class User(AbstractUser):
    ...
    # this works as a variable but it's still a function
    @property
    def revenue(self):
...
class Order(models.Model):
    #field where we complete payment it will give us an id
    transaction_id = models.CharField(max_length=255, null=True)
    #connection between the user and orders
    #data about ambassador user, code, ambassador
